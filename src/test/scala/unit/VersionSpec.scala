...
class VersionSpec(implicit ee: ExecutionEnv) extends Specification with FutureMatchers with ResultMatchers with MockHelper {

  "KairosDB#version" should {
    "return the correct version number" in {
      val mockWs = MockWS {
